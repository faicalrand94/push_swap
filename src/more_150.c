...
/*   Updated: 2021/06/09 17:53:11 by fbouibao         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../push_swap.h"

int	n1_more_150(t_pushswap *all, int *i, int *j)
{
...
void	norm1_more_150(t_pushswap *all)
{
	int	i;
	int	j;
...
void	n2_more_150(t_pushswap *all)
{
...
void	norm2_more_150(t_pushswap *all)
{
